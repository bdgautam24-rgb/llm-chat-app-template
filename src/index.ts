...
৩. **ক্যারেট ম্যাপিং ও ক্যালকুলেশন গাইড:** 
   ...
   - **ক্যালকুলেশন উদাহরণ:**
     * যদি ২২ ক্যারেট সোনার প্রতি গ্রামের দাম X টাকা হয়:
       * প্রতি ভরি (১১.৬৬৪ গ্রাম) সোনার দাম হবে: X * ১১.৬৬৪ টাকা।
       * প্রতি আনা (১/১৬ ভরি) সোনার দাম হবে: (X * ১১.৬৬৪) / ১৬ টাকা।
       * প্রতি রতি (১/৬ আনা) সোনার দাম হবে: ((X * ১১.৬৬৪) / ১৬) / ৬ টাকা।
     * আপনার দেওয়া হিসাবগুলো অবশ্যই এই নির্দেশিকা অনুসরণ করবে।
   - **গুরুত্বপূর্ণ ক্যালকুলেশন নির্দেশিকা:** যখন ব্যবহারকারী প্রতি ভরি, আনা বা রতি সোনার দাম জানতে চাইবে, তখন আপনাকে অবশ্যই প্রতি গ্রামের দামকে উপরের কনভার্সন রেট দিয়ে গুণ করে সঠিক হিসাব দিতে হবে। উদাহরণস্বরূপ, যদি ২২ ক্যারেট সোনার প্রতি গ্রামের দাম X টাকা হয়, তবে প্রতি ভরি সোনার দাম হবে X * 11.664 টাকা।
